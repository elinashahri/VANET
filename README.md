...
The goal of this project is implementing the main stages of the pipeline and evaluating results with standard classification/regression metrics.


---

## Project Overview
The implementation follows a **three-phase pipeline** inspired by the paper:
